...
from src.transformers.models.vit.vision_transformer import Mlp, PatchEmbed
from timm.models.layers import trunc_normal_


__all__ = [
    'CaiT', 'cait_xxs24_patch16_224', 'cait_xxs24_patch16_384', 'cait_xxs36_patch16_224',
    'cait_xxs36_patch16_384', 'cait_xs24_patch16_384', 'cait_s24_patch16_224',
    'cait_s24_patch16_384', 'cait_s36_patch16_384', 'cait_m36_patch16_384',
    'cait_m48_patch16_448'
]
...
def cait_xxs24_patch16_224(cfg):
    model = CaiT(
        img_size=cfg.CONFIG.DATA.IMG_SIZE,
...
def cait_xxs24_patch16_384(cfg):
    model = CaiT(
        img_size=cfg.CONFIG.DATA.IMG_SIZE,
        patch_size=cfg.CONFIG.MODEL.PATCH_SIZE,
        embed_dim=192,
...
def cait_xxs36_patch16_224(cfg):
    model = CaiT(
        img_size=cfg.CONFIG.DATA.IMG_SIZE,
        patch_size=cfg.CONFIG.MODEL.PATCH_SIZE,
        embed_dim=192,
...
def cait_xxs36_patch16_384(cfg):
    model = CaiT(
        img_size=cfg.CONFIG.DATA.IMG_SIZE,
        patch_size=cfg.CONFIG.MODEL.PATCH_SIZE,
        embed_dim=192,
