...
_C.CONFIG.TRAIN.EPOCH_NUM = 50
# Per GPU mini-batch size
_C.CONFIG.TRAIN.BATCH_SIZE = 6
# Base learning rate
_C.CONFIG.TRAIN.LR = 0.01
# L2 regularization
_C.CONFIG.TRAIN.WEIGHT_DECAY = 0.05
# Gradually warm up the SOLVER.BASE_LR over this number of epochs
_C.CONFIG.TRAIN.WARMUP_EPOCHS = 5
# The start learning rate of the warm up
_C.CONFIG.TRAIN.WARMUP_START_LR = 0.001
# The minimal learning rate during training
_C.CONFIG.TRAIN.MIN_LR = 0.001
# Resume training from a specific checkpoint
_C.CONFIG.TRAIN.RESUME = ''

# LR scheduler
_C.CONFIG.TRAIN.LR_SCHEDULER = CN()
# LR scheduler name
_C.CONFIG.TRAIN.LR_SCHEDULER.NAME = 'step'
# Epoch interval to decay LR, used in StepLRScheduler
_C.CONFIG.TRAIN.LR_SCHEDULER.DECAY_EPOCHS = 25
# Specific epoch milestones to decay LR, used in MultiStepLRScheduler
_C.CONFIG.TRAIN.LR_SCHEDULER.LR_MILESTONE = [25, 40]
...
# Optimizer name
_C.CONFIG.TRAIN.OPTIMIZER.NAME = 'sgd'
# Optimizer Epsilon
...
# AMP setting
_C.CONFIG.TRAIN.USE_AMP = False
_C.CONFIG.TRAIN.AMP_LEVEL = "O0"

# EMA setting
_C.CONFIG.TRAIN.USE_EMA = False
_C.CONFIG.TRAIN.EMA_DECAY = 0.99996
_C.CONFIG.TRAIN.EMA_FORCE_CPU = False

# Gradient norm setting
_C.CONFIG.TRAIN.CLIP_GRAD = 0.0
...
# Whether to load a checkpoint file. If True, please set the above PRETRAINED_PATH
